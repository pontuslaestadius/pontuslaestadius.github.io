...
export default class Player extends Entity {
    constructor() {
        ...
        this.spriter = {
            ...
            attack1: this.framer(1, 6, 4, () => {
                this.attack = false;
                this.idle_sprite = 'idle2'
            }),
            attack2: this.framer(0, 7, 4, () => {
                this.attack = false;
                this.idle_sprite = 'idle2'
            }),
            attack3: this.framer(6, 13, 4, () => {
                this.attack = false;
                this.idle_sprite = 'idle2'
            }),
            attack4: this.framer(2, 14, 3, () => {
                this.attack = false;
                this.idle_sprite = 'idle2'
            }),
            attack5: this.framer(4, 14, 4, () => this.attack_sprite = 'attack6'),
            attack6: this.framer(5, 14, 2, () => {
                if (this.v.y !== 0) {
                    return;
                }
                this.attack = false;
    ...
    calc() {
        ...
        this.v.x = Helper.minmax(this.v.x, -25, 25);
