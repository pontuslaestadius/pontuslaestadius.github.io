    ...
    render() {
        return ( <
            ...
            content = {
                ...
                all my projects,
                another reference table can be
                found < a href = 'https://github.com/pontuslaestadius/portfolio' > here < /a>.
                This page will consist of project writeups and a programming related blog. <br></br>
                < /p >
                ...
                <
                p >
                I am a 3 rd year Software Engineering & Management Student at Gothenbourg University.
                I also intern part - time at Ericsson,
                but a lot of my spare - time revolves around
                learning new Programming languages,
                tools,
                algorithms and useful skills. <
                /p> < /
                React.Fragment >
            }
            /> <
            ...
            description = {
                ...
                <
                p >
                Pathfinder is a Node based graphics library
                for generating images and gifs with connected nodes. <
                /p> <
                p >
                A two year project which is still in progress,
                with 1400 + downloads. <
                /p> <
                p >
            ...
            /> <
            FancySection title = 'js-irt'
            images = {
                <
                React.Fragment >
                <
                img alt = 'Test example'
                src = 'resources/jsirt.gif' / >
                <
                /React.Fragment>
            }
            links = {
            ...
            description = {
                ...
                p >
                js - irt stands
                for Javascript inline Rust testing <
                /p> <
                p >
